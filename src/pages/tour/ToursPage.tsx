    ...
    return (
        <div className="min-h-screen bg-[#f6f7fb] text-slate-900 p-6">
            ...
            <div className="mx-auto mb-5 flex w-[min(96vw,1100px)] items-center gap-3">
                <button className="grid h-9 w-9 place-items-center rounded-full border border-slate-200 bg-white shadow-md">
            ...
            {!loading && !error && (
                <div className="mx-auto grid w-[min(96vw,1100px)] grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    {filtered.map((t) => {
                        ...
                        return (
                            <div key={t.id} className="rounded-2xl border border-indigo-50 bg-white p-3 shadow-[0_10px_28px_rgba(15,23,42,0.08)] transition hover:-translate-y-0.5 hover:shadow-[0_14px_32px_rgba(15,23,42,0.12)]" >
