...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex flex-col md:flex-row flex-1 px-4 sm:px-6 md:px-20 pb-10 gap-8">
        <div className="flex-1 flex items-center justify-center bg-gray-100 rounded-2xl p-3 sm:p-4 md:p-6">
          <img
            src="/src/assets/signup.png"
            alt="illustration"
            className="max-w-[250px] sm:max-w-sm md:max-w-md w-full rounded-2xl"
          />
        </div>

        <div className="flex-1 flex flex-col justify-center px-2 sm:px-6 md:px-8">
          <div className="flex flex-col items-center justify-center text-center max-w-2xl w-full mx-auto">
            ...
            >
              ...
              <div className="flex flex-col text-gray-600 text-sm gap-1 my-2">
    ...
    2.84c.87-2.6 3.3-4.53 6.16-4.53z"
                ...
                <div className="text-center mb-6">
                  ...
                  <Link
                    to="/Login"
                    className="text-blue-800 font-bold font-serif text-md hover:underline ml-1"
                  >
                    Sign in
                  </Link>
                </div>
