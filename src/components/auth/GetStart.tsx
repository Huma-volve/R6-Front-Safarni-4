...
export default function GetStart() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <header className="w-full hidden md:flex justify-end px-6 md:px-20 md:pt-4">
      ...
      <div className="flex flex-col md:flex-row flex-1 px-6 md:px-16 pb-10 gap-8">
        ...
        <div className="flex-1 flex flex-col justify-center px-4 md:px-8">
          <div className="flex flex-col items-center justify-center text-center  max-w-lg mx-auto md:mx-0">
            <h1 className="text-xl sm:text-2xl md:text-2xl font-semibold text-black mb-3">
              Welcome
            </h1>

            <p className="text-gray-600 mb-5 text-base sm:text-lg md:text-xl leading-relaxed max-w-110 md:max-w-lg ">
